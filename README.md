...
## Использование
1. Создать объект класса Product. Наследуется от классов BaseProduct(абстрактный) и MixinInfo. (classes.py)
```
...
Определяет обязательные абстрактные методы __add__, __str__, геттер price, сеттер price, new_product

## Класс MixinInfo

Выводит при инициализации информацию о классе, от которого создан продукт и его параметры.
